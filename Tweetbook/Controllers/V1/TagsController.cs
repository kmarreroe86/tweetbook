...
{
    // [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Admin, Poster")] => Roles when use authorization with roles
    ...
    public class TagsController : Controller
    {
        ...
        // [Authorize(Policy = "TagViewer")]  Protecting the route with claim
        public async Task<IActionResult> GetAll()
        {
            var tagModels = await _postService.GetAllTagsAsync();

            return Ok(_mapper.Map<List<TagResponse>>(tagModels));
        }
        ...
        // [Authorize(Roles = "Admin")]          => Protect by role
        [Authorize(Policy = "MustWorkForKarel")] // Protect by policy
